    ...
    <mat-sidenav-container class="h-screen w-full bg-gray-50">
      ...
      <mat-sidenav #sidenav [mode]="isMobile ? 'over' : 'side'" [opened]="!isMobile" class="w-64 border-r-2 border-gray-900 bg-white shadow-[4px_0_0_0_rgba(17,24,39,1)]">
        <mat-toolbar class="bg-primary-50 border-b-2 border-gray-900 flex items-center px-4">
          ...
          <span class="text-xl font-black text-gray-900 uppercase tracking-tight" style="font-family: 'Arial Black', Impact, sans-serif;">Municipality</span>
        </mat-toolbar>
        ...
        <mat-nav-list class="pt-4 px-2">
          ...
          <a mat-list-item routerLink="/admin/users" routerLinkActive="bg-primary-100 text-primary-900 border-2 border-gray-900 shadow-[2px_2px_0px_0px_rgba(17,24,39,1)]" class="hover:bg-gray-50 transition-all rounded-sm mb-2">
          ...
          <a mat-list-item routerLink="/admin/announcements" routerLinkActive="bg-primary-100 text-primary-900 border-2 border-gray-900 shadow-[2px_2px_0px_0px_rgba(17,24,39,1)]" class="hover:bg-gray-50 transition-all rounded-sm mb-2">
          ...
          <mat-divider class="my-4 border-t-2 border-gray-900 mx-2"></mat-divider>
          <div mat-subheader class="text-[10px] font-black text-gray-400 uppercase tracking-widest mb-2 px-4">Switch Portal</div>

          <a mat-list-item routerLink="/citizen" class="hover:bg-gray-50 transition-all rounded-sm">
            <mat-icon matListItemIcon class="text-gray-900">public</mat-icon>
            <span matListItemTitle class="font-bold uppercase tracking-wider text-[11px] text-gray-600">Citizen View</span>
          </a>
        </mat-nav-list>
