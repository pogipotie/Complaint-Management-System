    ...
    <div class="space-y-6">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6">
        ...
        <div class="relative group animate-pulse-slow">
          <div class="absolute inset-0 bg-red-900 rounded-sm translate-x-1.5 translate-y-1.5 transition-transform group-hover:translate-x-2 group-hover:translate-y-2"></div>
          <div class="relative bg-red-50 border-2 border-red-900 rounded-sm overflow-hidden h-full flex flex-col transition-transform group-hover:-translate-x-0.5 group-hover:-translate-y-0.5 p-6">
            <div class="flex items-center space-x-4">
              <div class="flex-shrink-0 bg-red-200 p-3 rounded-full border-2 border-red-900 shadow-[2px_2px_0px_0px_rgba(127,29,29,1)]">
                <mat-icon class="text-red-700 scale-150">whatshot</mat-icon>
              </div>
              <div>
                <p class="text-[11px] font-black text-red-900 uppercase tracking-widest m-0">Escalated</p>
                <p class="text-3xl font-black text-red-900 m-0 mt-1" style="font-family: 'Arial Black', Impact, sans-serif;">{{ escalatedComplaints }}</p>
              </div>
            </div>
          </div>
        </div>
