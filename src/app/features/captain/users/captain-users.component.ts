...
export class CaptainUsersComponent implements OnInit {
  ...
  async loadUsers() {
    ...
    if (!error && data) {
      ...
      // the shared extractStoragePath helper (handles both new paths and
        ...
        if (signedUrls) {
          ...
          this.users.forEach(u => {
            ...
            if (match?.signedUrl) {
              ...
              // Don't leave the raw path in proof_of_residency_url, the
              // <img> tag would try to load it as a relative URL.
