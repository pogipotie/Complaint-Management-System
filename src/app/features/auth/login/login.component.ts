  ...
  template: `
    <div class="min-h-screen flex items-center justify-center p-4 sm:p-6 lg:p-8 relative overflow-hidden">
      ...
      <div class="absolute inset-0 z-0">
        ...
        <div class="absolute inset-0 bg-gradient-to-r from-white/95 via-white/80 to-white/40"></div>
      </div>
      ...
      <div class="relative z-10 w-full max-w-4xl mx-auto">
        ...
        <!-- Back to home -->
        <div class="mb-4">
          <a routerLink="/" class="inline-flex items-center gap-2 text-sm font-semibold text-gray-700 hover:text-primary-600 transition-colors">
            <mat-icon class="text-base">arrow_back</mat-icon>
            Back to home
          </a>
        </div>

        <div class="relative bg-white rounded-sm overflow-hidden border-2 border-gray-900 shadow-[4px_4px_0px_0px_rgba(17,24,39,1)] flex flex-col sm:flex-row w-full">
          ...
          <div class="w-full sm:w-7/12 p-6 sm:p-10 flex flex-col justify-center bg-white">
            ...
            <div class="mt-8 text-center pb-4 sm:pb-0">
              <a routerLink="/auth/register" class="font-bold text-gray-900 hover:text-primary-600 bg-white py-2 px-6 rounded-sm shadow-[2px_2px_0px_0px_rgba(17,24,39,1)] border-2 border-gray-900 inline-block uppercase tracking-wider text-[11px] transition-colors">
