-- Fix the complaint trigger to bypass RLS when querying users for notifications
-- By adding SECURITY DEFINER, the trigger runs with elevated privileges,
-- allowing it to successfully find admin and brgy_captain user IDs despite the strict
